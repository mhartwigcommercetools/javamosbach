...
import com.education.mosbach.algorithms.structures.storageImpl.ArrayStackStorageImpl;
...
public class TestArrayStackStorageImpl {

    private Storage stack;

    @Before
    public void before() {
        stack = new ArrayStackStorageImpl();
    }
